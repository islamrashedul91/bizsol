...
%>	
	<form action="PurchaseMainController" method="post" name="frmSave">
		<div class="form-style-2-heading">Provide your information </div>
			...
			%>
			<label for="field17"><span>Created By </span>
				<input type="text" class="input-field-60" readonly="readonly" name="created_by" id="created_by" value="${purchaseMain.created_by}"  maxlength=40 size=40 /> 
			</label>
			<%
			}
			%>
			...
			%>
			<label for="field18"><span>Updated By </span>
				<input type="text" class="input-field-60" readonly="readonly" name="updated_by" id="updated_by" value="${purchaseMain.updated_by}"  maxlength=40 size=40 /> 
			</label>
			<%
			} else if (action.equalsIgnoreCase("edit")) {
			%>
