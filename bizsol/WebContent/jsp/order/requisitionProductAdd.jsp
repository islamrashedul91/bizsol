	...
	<form action="RequisitionProductController" method="post" name="frmSave">
		<div class="form-style-2-heading">Provide your information </div>
			...
			<label for="field12"><span>Order Quantity <span class="required">*</span></span>
				<input type="text" class="input-field-60" name="order_quantity" id="order_quantity" value="${requisitionProduct.order_quantity}" onchange="quantityToTotalMRP(); discountToTotalAmount();" onkeypress="return checkDigit(event);" maxlength=10 size=40 required /> 
			</label>
			...
			<label for="field15"><span>Discount Amount <span class="required">*</span></span>
				<input type="text" class="input-field-60" name="discount_amt" id="discount_amt" value="${requisitionProduct.discount_amt}" onchange="discountToTotalAmount();" onkeypress="return checkDigitWithDot(event);" maxlength=10 size=40 required /> 
			</label>
